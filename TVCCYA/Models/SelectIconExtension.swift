...
extension SelectIconCollectionViewController {
    ...
    func setupCells() {
        ...
        icons = [workout, book, laptop, gaming, tv, groceries, garden, cooking, writing, heart, cash, build, dog, shopping, movie, health, camp, drink, coffee, haircut, clean, laundry, bed]
    }
}
